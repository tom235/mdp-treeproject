...
!define APP_NAME "Components"
!define COMP_NAME "Tomsha, Lozovik"
!define WEB_SITE "https://github.com/tom235/mdp-treeproject"
!define VERSION "1.0.1.0"
!define COPYRIGHT "Tomsha, Lozovik  © 2014"
!define DESCRIPTION "Components"
!define INSTALLER_NAME "components-installer.exe"
!define MAIN_APP_EXE "components_src.exe"
...
InstallDir "$PROGRAMFILES\Components"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Components"
...
SetOutPath "$INSTDIR"
File "package\components_src.exe"
...
CreateDirectory "$SMPROGRAMS\Components"
CreateShortCut "$SMPROGRAMS\Components\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}" "-platformpluginpath plugins"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}" "-platformpluginpath plugins"
CreateShortCut "$SMPROGRAMS\Components\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

!ifdef WEB_SITE
WriteIniStr "$INSTDIR\${APP_NAME} website.url" "InternetShortcut" "URL" "${WEB_SITE}"
CreateShortCut "$SMPROGRAMS\Components\${APP_NAME} Website.lnk" "$INSTDIR\${APP_NAME} website.url"
!endif
!endif
...
Section Uninstall
${INSTALL_TYPE}
Delete "$INSTDIR\components_src.exe"
...
!ifndef REG_START_MENU
Delete "$SMPROGRAMS\Components\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\Components\Uninstall ${APP_NAME}.lnk"
!ifdef WEB_SITE
Delete "$SMPROGRAMS\Components\${APP_NAME} Website.lnk"
!endif
Delete "$DESKTOP\${APP_NAME}.lnk"

RmDir "$SMPROGRAMS\Components"
!endif
